...
<html lang="en">
  ...
  <body style="background: #ececec;">
    ...
    <div class="col-12 d-flex justify-content-center align-items-center mb-4" style="margin-top: 100px;">
      <div class="col-11"><h1>Ürün Kategorileri</h1></div>
    </div>
      ...
      <div class="col-11 bg-white rounded-5 p-4">
        <div class="col-12">
          ...
          <div class="col-12 d-flex justify-content-end">
            <button type="button" data-bs-toggle="modal" data-bs-target="#ogrenci_ekleme_modal" class="btn btn-primary">Kategori Ekle</button>
          </div>
          <div style="overflow: auto;" class="col-12">
            ...
            <tbody>
              @foreach($kategoriler as $kategori)
                <tr>
                  <td>{{ $kategori->ad }}</td>
                  <td><button type="button" data-bs-toggle="modal" data-bs-target="#ogrenci_duzenleme_modal" class="btn btn-warning" onclick="duzenleme_modal('{{ $kategori->id }}', '{{ $kategori->ad }}')">Düzenle</button> <button type="button" data-bs-toggle="modal" data-bs-target="#ogrenci_silme_modal" class="btn btn-danger" onclick="silme_modal('{{ $kategori->id }}')">Sil</button></td>
                </tr>
              @endforeach
            </tbody>
          </table>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <h1 class="modal-title fs-5" id="ModalLabel">Kategori Ekle</h1>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
          </div>
          <form action="/kategori_ekle" method="post">
            @csrf
            <div class="modal-body">
              <label for="ad">Kategori Adı </label>
              <input class="form-control mt-2" type="text" name="ad" id="ad">
            </div>
    ...
    <div class="modal fade" id="ogrenci_silme_modal" tabindex="-1" aria-labelledby="ModalLabel" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <h1 class="modal-title fs-5" id="ModalLabel">Kategori Sil</h1>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
          </div>
          <form action="/kategori_sil" method="post">
            @csrf
            <div class="modal-body">
              <input type="hidden" name="id" id="silme_id">
              Kategoriyı silmek istediğinize emin misiniz?<br>"Bu işlem geri alınamaz."
            </div>
            <div class="modal-footer">
...
<!--  <div class="modal fade" id="exel_ekleme_modal" tabindex="-1" aria-labelledby="ModalLabel" aria-hidden="true">
     ...
     <div class="modal fade" id="ogrenci_duzenleme_modal" tabindex="-1" aria-labelledby="ModalLabel" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <h1 class="modal-title fs-5" id="ModalLabel">Kategori Düzenle</h1>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
          </div>
          <form action="/kategori_duzenle" method="post">
            @csrf
            <div class="modal-body">
             <div>
                <input type="hidden" name="id" id="duzenleme_id">
                <label for="duzenlemeadsoyad">Kategori Adı</label>
                <input class="form-control mt-2" type="text" name="ad" id="duzenleme_adsoyad">
             </div>
            </div>
            <div class="modal-footer">
              <button type="button" class="btn btn-danger" data-bs-dismiss="modal">İptal</button>
