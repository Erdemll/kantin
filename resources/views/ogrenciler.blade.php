            ...
            <tbody>
              @foreach($ogrenciler as $ogrenci)
                <tr>
                  ...
                  <td>{{ $ogrenci->bakiye }}</td>
                  <td><button type="button" data-bs-toggle="modal" data-bs-target="#ogrenci_duzenleme_modal"
                      class="btn btn-warning"
                      onclick="duzenleme_modal('{{ $ogrenci->id }}', '{{ $ogrenci->adsoyad }}')">Düzenle</button> <button
                      type="button" data-bs-toggle="modal" data-bs-target="#ogrenci_silme_modal" class="btn btn-danger"
                      onclick="silme_modal('{{ $ogrenci->id }}')">Sil</button></td>
                </tr>
              @endforeach
            </tbody>
          </table>
        ...
        <form action="/exel_exle" method="post" enctype="multipart/form-data">
          ...
          <div class="modal-body">
            <div class="mb-3">
              ...
              <input class="form-control" type="file" id="excel_file" name="excel_file" accept="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet">
            </div>
          </div>
          <div class="modal-footer">
            <button type="button" class="btn btn-danger" data-bs-dismiss="modal">İptal</button>
