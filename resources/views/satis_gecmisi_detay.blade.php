...
<html lang="en">
  ...
  <body style="background: #ececec;">
    ...
    <div class="col-12 d-flex justify-content-center align-items-center mb-4" style="margin-top: 100px;">
      <div class="col-11"><h1><span>{{ $ogrenci->adsoyad }}</span> Satış Geçmişi</h1></div>
    </div>
            ...
            <tbody>
              @foreach($satislar as $satis)
                <tr>
                  ...
                  <td><a href="/ogrenci/{{ $satis->ogrenci->id }}" class="text-secondary link-offset-2 link-underline link-underline-opacity-25">{{ $satis->ogrenci->adsoyad ?? ''}}</a></td>
